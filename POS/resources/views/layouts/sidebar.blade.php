...
{{-- <nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        {{-- Profil selalu bisa diakses semua user --}}
        {{-- <li class="nav-item">
            <a href="{{ route('profile.edit') }}" class="nav-link {{ ($activeMenu == 'profile')? 'active' : '' }}">
                <i class="nav-icon fas fa-user-circle"></i>
                <p>Profil Saya</p>
        ...
        {{-- Untuk ADM, MNG, STF --}}
        {{-- @if(in_array(auth()->user()->level_id, ['ADM', 'MNG', 'STF']))
            <li class="nav-header">Data Barang</li>
            <li class="nav-item">
                <a href="{{ url('/kategori') }}" class="nav-link {{ ($activeMenu == 'kategori')? 'active' : '' }}">
                    <i class="nav-icon far fa-bookmark"></i>
        ...
        {{-- Untuk ADM dan MNG --}}
        {{-- @if(in_array(auth()->user()->level_id, ['ADM', 'MNG']))
            <li class="nav-item">
                <a href="{{ url('/supplier') }}" class="nav-link {{ ($activeMenu == 'supplier')? 'active' : '' }}">
                    <i class="nav-icon fas fa-truck"></i>
                    <p>Data Supplier</p>
        ...
        {{-- Untuk semua yang boleh transaksi --}}
        {{-- @if(in_array(auth()->user()->level_id, ['ADM', 'MNG', 'STF']))
            <li class="nav-header">Data Transaksi</li>
            <li class="nav-item">
                <a href="{{ url('/stok') }}" class="nav-link {{ ($activeMenu == 'stok')? 'active' : '' }}">
